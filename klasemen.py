...
update_klasemen_A("Mancasan A", "Kalimanjung", 75, 43, 3, 0)          #4.1_23-09-2025
...
streamlit.badge("Last update: 23 September 2025 21:51:36", icon=":material/check:", color="green")
# new line
streamlit.divider()
streamlit.write("\n\n")
